...
import {
  AddCandidateBtn, HeaderContainer, Heading,
} from './styled';
...
const Header = ({ title }: HeaderProps) => {
  const { jobs: { setSearchQuery } } = useStore();
  const [isOpenCreateCandidateForm, setIsOpenCreateCandidateForm] = useState(false);
  const handleSetIsOpenCreateCandidateForm = () => setIsOpenCreateCandidateForm((prevState) => !prevState);
    ...
    <HeaderContainer>
      ...
      >
        <Popup onClose={handleSetIsOpenCreateCandidateForm}>
          <AddCandidate
            onCreate={handleSetIsOpenCreateCandidateForm}
          />
        </Popup>
      </CSSTransition>
    </HeaderContainer>
